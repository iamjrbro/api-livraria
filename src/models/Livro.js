...
const livroSchema = new mongoose.Schema({
    ...
    preco:{type: Number},
    paginas:{type: Number}
}, {versionKey: false}); //sem versionamento de schema

const livro = mongoose.model("livros", livroSchema); //referente a colecao, por isso passa-se a coleção de referencia e seu schema
